...
class GroupDetails extends Component {
    static navigationOptions = ({ navigation }) => {
        ...
        return {
            ...
            headerRight: (
                isReady ? <Button title="Done" onPress={state.params.updateGroup}/> : undefined
            ),
        };
    };
...
const groupQuery = graphql(GROUP_QUERY, {
    options: ownProps => ({ variables: { groupId: ownProps.navigation.state.params.id, limit: 10, offset: 0 } }),
